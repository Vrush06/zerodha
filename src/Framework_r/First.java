...
public class First {
	...
	public static void main(String[] args) throws Throwable {
		...
		FileInputStream fis=new FileInputStream("C:\\\\Users\\\\vrush\\\\OneDrive\\\\Documents\\\\FirstMy.xlsx");
 org.apache.poi.ss.usermodel.Sheet sh = WorkbookFactory.create(fis).getSheet("sheet2");
		//set the properties
